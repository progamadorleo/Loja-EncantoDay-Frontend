        ...
        <section className="relative py-16 md:py-24 bg-gradient-to-b from-primary/5 to-background">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Somos apaixonados por realcar a beleza unica de cada pessoa. 
              Nossa missao e oferecer produtos de qualidade que fazem voce se sentir incrivel todos os dias.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    A Encanto Day nasceu do sonho de tornar a beleza acessivel a todas as mulheres. 
                    Acreditamos que cada pessoa merece se sentir confiante e radiante.
                  </p>
                  <p>
                    Selecionamos cuidadosamente cada produto do nosso catalogo, 
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Cada cliente e especial. Tratamos todas com carinho e atencao personalizada.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Selecionamos apenas produtos de marcas confiaveis e com qualidade comprovada.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="font-semibold text-foreground mb-2">Entrega Rapida</h3>
                <p className="text-sm text-muted-foreground">
                  Trabalhamos para que seus produtos cheguem o mais rapido possivel.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              ...
              dicas de beleza e promocoes exclusivas.
            </p>
            <a
